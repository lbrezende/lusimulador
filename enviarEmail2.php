...
$tabela = gerarTabelaEmail($valorFinanciado, $prazoPagamento, $taxaJurosMensal);

//Variaveis fixas
$remetente = 'sousafs@globo.com, conta@consultorialus.com';
...
$message2 = 'Olá Lu, o cliente com e-mail: '.$email.', fez uma simulação com essa tabela. Entre em contato com ele:<br /><br /> '. $tabela;
